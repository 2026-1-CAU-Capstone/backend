...
public final class NoteUtils {
    ...
    /**
     * Parse key string like "C", "Bb", "F#m" → [rootPc, mode].
     * mode: "major" or "minor".
     */
    public static KeyInfo parseKey(String keyStr) {
        ...
        if (pc < 0) throw new IllegalArgumentException("Cannot parse key: " + keyStr);
    ...
    public record KeyInfo(int root, String mode) {
        public boolean isMajor() { return "major".equals(mode); }
        public boolean isMinor() { return "minor".equals(mode); }
    }
}
