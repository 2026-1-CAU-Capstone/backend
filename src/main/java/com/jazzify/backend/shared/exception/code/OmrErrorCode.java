...
public enum OmrErrorCode implements BaseErrorCode {
	...
	OMR_FILE_READ_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "OMR_007", "업로드 파일을 읽는 중 오류가 발생했습니다."),
	OMR_SUBMIT_FAILED(HttpStatus.BAD_GATEWAY, "OMR_008", "OMR 서버에 작업을 제출하지 못했습니다."),
	OMR_CALLBACK_KEY_INVALID(HttpStatus.UNAUTHORIZED, "OMR_009", "OMR 콜백 API 키가 유효하지 않습니다."),
	OMR_JOB_NOT_FOUND(HttpStatus.NOT_FOUND, "OMR_010", "해당 OMR 작업을 찾을 수 없습니다.");
