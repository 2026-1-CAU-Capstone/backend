...
| --- | --- | --- |
| `file` | 예 | PNG/JPG/JPEG 악보 이미지 |
| `title` | 아니오 | 미입력 시 생성 직후 제목 `Untitled`, 완료 후 OMR 제목 fallback |
| `key` | 아니오 | `MusicKey` enum 이름 또는 조성 표기. 예: `C_MAJOR`, `B_FLAT_MAJOR`, `C`, `Bb`, `F#m` |
...
| --- | --- | --- |
| `file` | 예 | PNG/JPG/JPEG 악보 이미지 |
| `title` | 아니오 | 미입력 시 생성 직후 제목 `Untitled`, 완료 후 MusicXML 제목 사용 |
